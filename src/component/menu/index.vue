<template>
  <a-layout-sider :theme="$store.state.theme" class="menu" :trigger="null" collapsible v-model="collapsed" width="256px">
    <a class="logo">
    ...
    <a-menu style="padding: 16px 0;" :theme="$store.state.theme" mode="inline" v-model="selectedKeys" :openKeys.sync="openKeys">
